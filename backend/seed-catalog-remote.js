// Remote seed script - can be run via Render shell
// To run: Copy this script to Render shell and execute with node

const { PrismaClient } = require('@prisma/client');
const { v4: uuidv4 } = require('uuid');

// Use DATABASE_URL from environment (already set in Render)
...
async function seedCatalog() {
    console.log('🌱 Rachel Foods Catalog Seed\n');
