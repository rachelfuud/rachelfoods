...
// Embedded SQL migration - no file system dependency
...
-- Content Pages (About Us, FAQ, Terms, etc.)
...
CREATE INDEX IF NOT EXISTS idx_content_pages_published ON content_pages("isPublished");
...
CREATE TABLE IF NOT EXISTS content_sections (
  ...
  "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT fk_content_sections_page FOREIGN KEY ("pageId") REFERENCES content_pages(id) ON DELETE CASCADE
);

CREATE INDEX IF NOT EXISTS idx_content_sections_pageId ON content_sections("pageId");
...
CREATE INDEX IF NOT EXISTS idx_media_assets_mimeType ON media_assets("mimeType");
...
VALUES (
  ...
  'header',
  '{"logo":{"url":"/logo.png","alt":"RachelFoods"},"navigation":[{"label":"Home","href":"/","order":1},{"label":"Products","href":"/catalog","order":2},{"label":"About","href":"/about","order":3},{"label":"Contact","href":"/contact","order":4}],"announcement":{"enabled":false,"text":"Welcome to RachelFoods!","link":"/catalog","backgroundColor":"#10b981","textColor":"#ffffff"}}'::jsonb,
  true,
  CURRENT_TIMESTAMP
...
export async function runCmsMigration() {
    ...
    `;
        ...
        // Execute embedded SQL migration
        await prisma.$executeRawUnsafe(CMS_MIGRATION_SQL);
