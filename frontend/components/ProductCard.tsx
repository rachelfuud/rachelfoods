        ...
        <Link href={`/products/${product.slug}`}>
            <div className={`border-2 border-border rounded-2xl p-5 hover:shadow-2xl hover:border-brand-accent/50 transition-all duration-300 bg-gradient-to-br from-brand-surface to-brand-muted/30 dark:from-surface dark:to-surface-elevated group ${status === 'DISABLED' ? 'opacity-60' : ''}`}>
                {product.imageUrl ? (
                    ...
                    <div className="relative aspect-square mb-4 rounded-xl bg-gradient-to-br from-muted to-brand-muted flex items-center justify-center ring-2 ring-border">
                ...
                <div className="flex items-baseline gap-2 mb-3">
                    <span className="text-3xl font-bold bg-gradient-to-r from-brand-primary to-primary-600 dark:from-primary-400 dark:to-primary-600 bg-clip-text text-transparent">
                ...
                <div className="flex items-center justify-between flex-wrap gap-2 mb-3">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {isFeatured && (
                            <span className="text-xs bg-gradient-to-r from-secondary-100 to-secondary-200 dark:from-secondary-900/30 dark:to-secondary-800/20 text-secondary-700 dark:text-secondary-400 px-3 py-1.5 rounded-full font-semibold border border-secondary-300 dark:border-secondary-700">
                                ⭐ Featured
                            </span>
                        )}
                    </div>
                ...
                {product.supportsRefill && !isOutOfStock && (
                    <div className="mt-4 pt-4 border-t-2 border-dashed border-brand-accent/30">
                        <div className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-accent-50 to-accent-100 dark:from-accent-900/20 dark:to-accent-800/10 border border-accent-200 dark:border-accent-800 group-hover:shadow-md transition-shadow">
                            <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-accent-400 to-accent-600 dark:from-accent-600 dark:to-accent-700 shadow-md">
